...
let yourSentence = "Michael, the \(nounArray[6]), got a \(nounArray[0]) recently."
let yourSillySentence = "That \(nounArray[index1]) is loving its new \(nounArray[index2])"
//: ### Exercise 2
...
let recreateShoutString = "HEY! " + didYouKnowString.uppercased()
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
let howManyCharactersCount = howManyCharacters.count //70
//: ### Exercise 4
...
//desired output = "$5.67"
let money: Double = (Double)(numOfPennies) / 100.0
print("$\(money)")
